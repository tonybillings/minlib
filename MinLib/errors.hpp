...
namespace minlib
{
	...
	static const char* CONFIG_ARG_ERROR = "Only one parameter, the filename of the config file, can be supplied without a name/key.  All other arguments must be passed as a key/value pair using the equal sign (k=v).";
